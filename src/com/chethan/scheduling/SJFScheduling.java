package com.chethan.scheduling;
import java.io.File;
...
public class SJFScheduling {
    public static void getSJFScheduling(HashMap<String, ProcessObject> processMap) {
        ...
        Collections.sort(
                processList,
                (i1,
                 i2) -> i1.getValue().getBurstTime().compareTo(i2.getValue().getBurstTime()));
    ...
    public static void main(String[] args) throws FileNotFoundException {
        Scanner sc = new Scanner(new File("input_files/input_sjf.csv"));
